...
fns="inputs/fastcats/GaussPZ_0.02+FullSky+run0+ztrue_mean.sacc"
fn='inputs/fastcats/GaussPZ_0.02+FullSky+run20+ztrue/twopoints20_ns2048.sacc'

s=sacc.SACC.loadFromHDF(fn,precision_filename=fns)
T=LSSTheory(s,zmax=1.6)
params={'omega_c':0.25,
        'omega_b':0.05,
        'omega_k':0.0,
        'sigma_8':0.8,
...
lmin=50
lmax=350
bz,bb=np.loadtxt('inputs/BzBlue.txt',unpack=True)
bofz=interp1d(bz,bb)
