...
class LSSTheory(object):
    def __init__(self,data_sacc, log_normal=True,zmin=None, zmax=None, lmin=None, lmax=None, diagonal=False) :
        self.s=sacc.SACC.loadFromHDF(data_sacc, zmin=zmin, zmax=zmax, lmin=lmin, lmax=lmax, diagonal=diagonal)
